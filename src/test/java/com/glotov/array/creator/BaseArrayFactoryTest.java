...
class BaseArrayFactoryTest {
    ...
    void testCreateBaseArrayWithValidInput() throws CustomException {
        ...
        Assertions.assertArrayEquals(array, baseArray.getElements());
    }
    ...
    void testCreateBaseArraysWithValidInput() {
        ...
        for (int i = 0; i < arraysList.size(); i++) {
            Assertions.assertArrayEquals(arraysList.get(i), baseArrays.get(i).getElements());
        }
    }
